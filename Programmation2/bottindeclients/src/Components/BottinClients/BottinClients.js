...
let tabClients = [
  ...
  },
  {
    ...
    nom: "Melody Harvey",
    profession: "Technicienne en laboratoires",
    courriel: <a href="mailto:harveymaud@gmail.com">harveymaud@gmail.com </a>,
    tel: <a href="tel:+1-819-523-3737">(819) 523-3737</a>,
    ...
    if (this.state.modeRecherche) {
      return (
        <Container fluid className="bg hauteur100">
          ...
          <Row>{this.affichageRecherche()}</Row>
        </Container>
      );
      ...
      return (
        <Container fluid className="bg">
          <Row className="text-center bgOpaqueBlanc pb-5">
            <Recherche
              onClick={this.changeString}
              recherche={this.modeRecherche}
            />
            <Col md={12} lg={6} className="mx-auto mt-5">
          ...
          <Row className="mt-3">{this.informationsClient()}</Row>
        </Container>
      );
    }
  }
