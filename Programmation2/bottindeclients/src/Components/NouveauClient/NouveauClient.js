                    ...
                    <Col xs={6}>
                        ...
                        <Form>
                            <Form.Group  >
                                ...
                                <Form.Control type="text" placeholder="numéro client" id="photoId" />
                                ...
                                <Form.Control type="text" placeholder="mail@gmail.com" id="courriel" />
                                <FormText>Téléphone</FormText>
                                <Form.Control type="text" placeholder="555-555-5555" id="tel" />
                                <FormText>Adresse</FormText>
                                <Form.Control type="text" placeholder="No., Nom de la rue" id="adresse" />
                            </Form.Group>
