...
server.post("/adventureMotorcycles", function (req, res, next) {
  const error = validateadventureMotorcycles(req.body);
...
function validateadventureMotorcycles(adventureMoto) {
  if (!adventureMoto.modele) return "Le modèle de la moto est obligatoire";
  return "";
}
